...
public enum ConstraintType {
    ...
    public static ConstraintType fromMySQL(String mySQLConstraintType){
        ...
        switch (mySQLConstraintType){
            ...
            case "PRIMARY KEY": return ConstraintType.PRIMARY_KEY;
            case "FOREIGN KEY": return ConstraintType.FOREIGN_KEY;
    ...
    public static ConstraintType fromOracle(String oracleConstraintType){
        switch (oracleConstraintType){
            case "C" : return ConstraintType.CHECK;
            case "P" : return ConstraintType.PRIMARY_KEY;
            case "R" : return ConstraintType.FOREIGN_KEY;
            case "U" : return ConstraintType.UNIQUE;
            default  : return null;
        }
    }
}
